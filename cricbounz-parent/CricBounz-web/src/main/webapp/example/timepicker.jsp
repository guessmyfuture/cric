                ...
                <div class="well">
                    <form name="form" class="form-horizontal ng-valid ng-dirty" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <table class="ng-isolate-scope ng-valid ng-valid-time ng-dirty" ng-model="mytime" show-meridian="showMeridian">
                                    <tbody>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-9">
                                <div class="checkbox">
                                    <label class="ng-binding"> <input checked="checked" class="ng-pristine ng-valid" name="showMeridian" ng-model="showMeridian" type="checkbox">
                                        Show meridian (true)
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="form-group"> 
                            <div class="col-sm-offset-3 col-sm-9 ng-binding">Value: 4:15 PM</div>
                        </div>
                    </form>
                </div>
            </div>
