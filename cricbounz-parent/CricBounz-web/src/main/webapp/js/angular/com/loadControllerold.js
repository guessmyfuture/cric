...
var dbApp = angular.module('dashboardModule', ['infinite-scroll', "ngRoute"]);

//angular.module("CricApp", ["dashboardModule", "teamModule", "groundModule", "tournamentModule", "file-model", "userModule", "jkuri.timepicker","ngRoute"]);
angular.module("CricApp", ["teamModule", "groundModule", "tournamentModule", "file-model", "userModule", "jkuri.timepicker"]);
...
//dbApp.controller('dashBoardCtrl', ['$scope', '$http', 'PostImages', function ($scope, $http, PostImages) {
//        // establish vars
//        $scope.postedData = [];
//        $scope.limit = 5;
//        $scope.offset = 0;
